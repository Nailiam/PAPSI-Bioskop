...
Public Class Report_Periodik
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SI_Bioskop.Report Periodik.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_Periodik
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_Periodik = New Report_Periodik()
        rpt.Site = Me.Site
        Return rpt
    End Function
