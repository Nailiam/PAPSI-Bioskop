...
Public Class Report_Ticket
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SI_Bioskop.Report Ticket.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ID_Receipt() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReport_Ticket
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_Ticket = New Report_Ticket()
        rpt.Site = Me.Site
        Return rpt
    End Function
