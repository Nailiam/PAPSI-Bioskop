...
Public Class Report_Data_Crew
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SI_Bioskop.Report Data Crew.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_Data_Crew
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_Data_Crew = New Report_Data_Crew()
        rpt.Site = Me.Site
        Return rpt
    End Function
